...
public class ControllerIntegrationTests {
    ...
    void getAllCountriesIntegrationTest() throws JSONException {
        ...
        ResponseEntity<String> response = restTemplate.getForEntity("http://localhost:8080/getcountries", String.class);//Takes 2 arguments, URl & - JSON or String format
    ...
    void getCountrybyIDIntegrationTest() throws JSONException {
        ...
        TestRestTemplate restTemplate=new TestRestTemplate();
        ResponseEntity<String> response = restTemplate.getForEntity("http://localhost:8080/getcountries/1", String.class);//Takes 2 arguments, URl & - JSON or String format
        System.out.println(response.getStatusCode());
        System.out.println(response.getBody());
    ...
    void getCountryByNameIntegrationTest() throws JSONException {
        ...
        TestRestTemplate restTemplate=new TestRestTemplate();
        ResponseEntity<String> response = restTemplate.getForEntity("http://localhost:8080/getcountries/countryname?name=Ghana", String.class);
        System.out.println(response.getStatusCode());
        System.out.println(response.getBody());
    ...
    void addNewCountryIntegrationTest() throws JSONException {
        Country country = new Country(4, "Liberia", "Monrovia");
